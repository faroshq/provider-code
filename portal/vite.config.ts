...
// The railgrid hub serves this provider under /ui/providers/code/. ProviderFrame
// injects <script src="/ui/providers/code/main.js"> and waits for the
// <railgrid-provider-code> custom element to be defined. So the build must emit
